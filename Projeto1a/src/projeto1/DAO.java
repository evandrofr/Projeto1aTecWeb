...
public class DAO {
	...
	public DAO() {
		...
		try {
			connection = DriverManager.getConnection(
					"jdbc:mysql://localhost/Projeto1","root","888941");
	...
	public void register(String usuario, String senha, String nome) throws SQLException {
	...
	public List<Nota> getLista(int usuario_id) {

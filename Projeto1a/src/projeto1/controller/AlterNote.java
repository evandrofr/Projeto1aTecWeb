...
/**
 * Servlet implementation class AlterNote
 */
@WebServlet("/AlterNote")
public class AlterNote extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			dao.alterNote(title,message,deadlineString,user_id,nota_id);
